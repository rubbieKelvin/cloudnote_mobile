...
main(){
    ...
    "/home/rubbiekelvin/Android/Sdk/ndk/21.3.6528147/prebuilt/linux-x86_64/bin/make" INSTALL_ROOT=$BUILD_FOLDER/android-build install /home/rubbiekelvin/Qt/5.15.2/android/bin/qmake -install qinstall -exe libcloudnote_armeabi-v7a.so $PROJECT_FOLDER/android-build/libs/armeabi-v7a/libcloudnote_armeabi-v7a.so
}
